...
import Propery from '../components/Property';
...
export default function Home({ propertiesForSale, propertiesForRent }) {
  return (
    <Box>
      ...
      />
      <Flex flexWrap="wrap">
        {propertiesForRent.map((property) => <Propery property={property} key={property.id} />)}
      </Flex>
      <Banner 
         purpose="BUY A HOME"
      ...
      />
      <Flex flexWrap="wrap">
        {propertiesForSale.map((property) => <Propery property={property} key={property.id} />)}
      </Flex>
    </Box>
  )
}
